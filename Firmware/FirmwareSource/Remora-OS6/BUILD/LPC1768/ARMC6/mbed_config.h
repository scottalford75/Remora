...
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE                                115200                                           // set by application[LPC1768]
...
#define MBED_CONF_SD_SPI_CLK                                              p7                                               // set by library:sd[LPC1768]
#define MBED_CONF_SD_SPI_CS                                               p8                                               // set by library:sd[LPC1768]
#define MBED_CONF_SD_SPI_MISO                                             p6                                               // set by library:sd[LPC1768]
#define MBED_CONF_SD_SPI_MOSI                                             p5                                               // set by library:sd[LPC1768]
...
#define MBED_CONF_TARGET_TICKLESS_FROM_US_TICKER                          1                                                // set by application[LPC1768]
