...
// Timer constructor
spiPRUtimer::spiPRUtimer(LPC_TIM_TypeDef* timer, IRQn_Type irq, uint32_t frequency, pruThread* ownerPtr):
	timer(timer),
	irq(irq),
	frequency(frequency),
...
void spiPRUtimer::timerTick(void)
{
	//Do something here
...
void spiPRUtimer::startTimer(void)
{
